...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--wandb_project', default='DAVIS',
        ...
        parser.add_argument('--vis', default='',
                            help='folder to dump visualizations (default: ckpt/visualization)')
        parser.add_argument('--dev_mode', action='store_true',
                            help='Run a quick dev cycle (few batches then eval)')
